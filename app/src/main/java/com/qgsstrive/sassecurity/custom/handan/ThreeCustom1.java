 ...
 */
public class ThreeCustom1 extends View {
    ...
    public ThreeCustom1(Context context) {
        this(context, null);
    }

    public ThreeCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ThreeCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast3");
