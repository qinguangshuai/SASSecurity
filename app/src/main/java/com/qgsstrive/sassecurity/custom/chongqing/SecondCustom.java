...
public class SecondCustom extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil cqncast2 = new SpUtil(getContext(), "cqncast2");
        String name2 = cqncast2.getName();

        if (name2.equals("true")) {
            canvas.drawLine(50, 180, 560, 180, mColorpaint);
            canvas.drawLine(565, 180, 640, 360, mColorpaint);
            canvas.drawLine(640, 360, 960, 360, mColorpaint);
        }else if (name2.equals("false")) {
            canvas.drawLine(50, 180, 560, 180, mPaint);
            canvas.drawLine(565, 180, 640, 360, mPaint);
