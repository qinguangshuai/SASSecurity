 ...
 */
public class OneCustom1 extends View {
    ...
    public OneCustom1(Context context) {
        this(context, null);
    }

    public OneCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OneCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
