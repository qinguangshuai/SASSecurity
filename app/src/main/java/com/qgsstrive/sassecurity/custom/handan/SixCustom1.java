 ...
 */
public class SixCustom1 extends View {
    ...
    public SixCustom1(Context context) {
        this(context, null);
    }

    public SixCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SixCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast6");
