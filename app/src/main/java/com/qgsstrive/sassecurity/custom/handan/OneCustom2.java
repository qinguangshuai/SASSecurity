 ...
 */
public class OneCustom2 extends View {
    ...
    public OneCustom2(Context context) {
        this(context, null);
    }

    public OneCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OneCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast11");
