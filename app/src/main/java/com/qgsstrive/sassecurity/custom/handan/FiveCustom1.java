 ...
 */
public class FiveCustom1 extends View {
    ...
    public FiveCustom1(Context context) {
        this(context, null);
    }

    public FiveCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FiveCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast5");
