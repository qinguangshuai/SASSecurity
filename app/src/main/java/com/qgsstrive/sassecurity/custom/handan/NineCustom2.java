 ...
 */
public class NineCustom2 extends View {
    ...
    public NineCustom2(Context context) {
        this(context, null);
    }

    public NineCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NineCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast99");
