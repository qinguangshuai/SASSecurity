 ...
 */
public class TenCustom1 extends View {
    ...
    public TenCustom1(Context context) {
        this(context, null);
    }

    public TenCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TenCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast10");
