 ...
 */
public class ZeroCustom2 extends View {
    ...
    public ZeroCustom2(Context context) {
        this(context, null);
    }

    public ZeroCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZeroCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast00");
