 ...
 */
public class SevenCustom1 extends View {
    ...
    public SevenCustom1(Context context) {
        this(context, null);
    }

    public SevenCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SevenCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast7");
