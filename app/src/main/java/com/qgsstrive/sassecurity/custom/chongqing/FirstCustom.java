...
public class FirstCustom extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil cqncast1 = new SpUtil(getContext(), "cqncast1");
        String name1 = cqncast1.getName();

        if (name1.equals("true")) {
            canvas.drawLine(50, 120, 540, 120, mColorpaint);
            //canvas.drawLine(540, 120, 640, 360, mColorpaint);
            canvas.drawLine(540, 120, 640, 360, mColorpaint);
