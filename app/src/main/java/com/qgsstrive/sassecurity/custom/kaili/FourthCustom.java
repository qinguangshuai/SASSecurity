 ...
 */
public class FourthCustom extends View {
    ...
    public FourthCustom(Context context) {
        this(context, null);
    }

    public FourthCustom(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public FourthCustom(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil itcast3 = new SpUtil(getContext(), "itcast3");
        String name3 = itcast3.getName();

        //initView(canvas);

        if (name3.equals("true")) {
            canvas.drawLine(50, 370, 400, 370, mColorpaint);
            canvas.drawLine(400, 370, 450, 445, mColorpaint);
            canvas.drawLine(450, 450, 680, 450, mColorpaint);
            ...
            canvas.drawLine(450, 450, 680, 450, mPaint);
