 ...
 */
public class SixCustom2 extends View {
    ...
    public SixCustom2(Context context) {
        this(context, null);
    }

    public SixCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SixCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast66");
