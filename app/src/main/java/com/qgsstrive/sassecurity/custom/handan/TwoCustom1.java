 ...
 */
public class TwoCustom1 extends View {
    ...
    public TwoCustom1(Context context) {
        this(context, null);
    }

    public TwoCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TwoCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast2");
