...
public class ThridCustom extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil itcast2 = new SpUtil(getContext(), "itcast2");
        String name2 = itcast2.getName();

        //initView(canvas);

        if (name2.equals("true")) {
            canvas.drawLine(50, 290, 400, 290, mColorpaint);
            canvas.drawLine(400, 290, 450, 210, mColorpaint);
            canvas.drawLine(450, 210, 650, 210, mColorpaint);
            canvas.drawLine(650, 210, 700, 135, mColorpaint);
            canvas.drawLine(700, 130, 960, 130, mColorpaint);
            ...
            canvas.drawLine(700, 130, 960, 130, mPaint);
            //canvas.drawText("货6",150,310,mTextPaint);
            //canvas.drawText("C2",500,230,mTextPaint);
        }
    }
