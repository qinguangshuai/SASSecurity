 ...
 */
public class NineCustom1 extends View {
    ...
    public NineCustom1(Context context) {
        this(context, null);
    }

    public NineCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NineCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast9");
