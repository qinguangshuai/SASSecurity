 ...
 * 货2
 */
public class EighthCustom extends View {
    ...
    public EighthCustom(Context context) {
        this(context, null);
    }

    public EighthCustom(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public EighthCustom(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil cqncast8 = new SpUtil(getContext(), "cqncast8");
        String name8 = cqncast8.getName();

        if (name8.equals("true")) {
            canvas.drawLine(50, 480, 770, 480, mColorpaint);
            //canvas.drawLine(770, 480,790, 420, mColorpaint);
            canvas.drawLine(770, 480, 810, 360, mColorpaint);
            canvas.drawLine(810, 360, 960, 360, mColorpaint);
        } else if (name8.equals("false")) {
            canvas.drawLine(50, 480, 770, 480, mPaint);
            //canvas.drawLine(770, 480,810,360, mPaint);
            canvas.drawLine(770, 480, 810, 360, mPaint);
