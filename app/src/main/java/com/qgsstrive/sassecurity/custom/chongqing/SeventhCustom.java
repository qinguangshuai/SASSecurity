 ...
 * 货3
 */
public class SeventhCustom extends View {
    ...
    public SeventhCustom(Context context) {
        this(context, null);
    }

    public SeventhCustom(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public SeventhCustom(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        SpUtil cqncast7 = new SpUtil(getContext(), "cqncast7");
        String name7 = cqncast7.getName();

        if (name7.equals("true")) {
            canvas.drawLine(50, 420, 790, 420, mColorpaint);
            //canvas.drawLine(790, 420,810,360, mColorpaint);
            canvas.drawLine(790, 420, 810, 360, mColorpaint);
            canvas.drawLine(810, 360, 960, 360, mColorpaint);
        }else if (name7.equals("false")) {
            canvas.drawLine(50, 420, 790, 420, mPaint);
            //canvas.drawLine(790, 420,810,360, mPaint);
            canvas.drawLine(790, 420, 810, 360, mColorpaint);
