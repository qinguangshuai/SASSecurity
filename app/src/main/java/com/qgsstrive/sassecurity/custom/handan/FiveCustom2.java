 ...
 */
public class FiveCustom2 extends View {
    ...
    public FiveCustom2(Context context) {
        this(context, null);
    }

    public FiveCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FiveCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast55");
