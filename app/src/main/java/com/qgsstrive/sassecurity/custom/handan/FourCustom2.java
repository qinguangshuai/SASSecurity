 ...
 */
public class FourCustom2 extends View {
    ...
    public FourCustom2(Context context) {
        this(context, null);
    }

    public FourCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FourCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast44");
