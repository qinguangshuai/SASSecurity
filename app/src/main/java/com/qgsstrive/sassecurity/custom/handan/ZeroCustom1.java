 ...
 */
public class ZeroCustom1 extends View {
    ...
    public ZeroCustom1(Context context) {
        this(context, null);
    }

    public ZeroCustom1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZeroCustom1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast0");
