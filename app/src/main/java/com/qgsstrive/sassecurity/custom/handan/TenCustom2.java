 ...
 */
public class TenCustom2 extends View {
    ...
    public TenCustom2(Context context) {
        this(context, null);
    }

    public TenCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TenCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast100");
