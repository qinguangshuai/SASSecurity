 ...
 */
public class ThreeCustom2 extends View {
    ...
    public ThreeCustom2(Context context) {
        this(context, null);
    }

    public ThreeCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ThreeCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast33");
