 ...
 */
public class EightCustom2 extends View {
    ...
    public EightCustom2(Context context) {
        this(context, null);
    }

    public EightCustom2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EightCustom2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Canvas canvas) {
        SpUtil itcast1 = new SpUtil(getContext(), "itcast88");
